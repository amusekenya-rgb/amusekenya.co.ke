-- Fix camp form slugs to match what the code expects
-- This removes the old incorrectly named forms and adds the correct ones

-- Delete old form configs with incorrect slugs (if they exist)
DELETE FROM content_items 
WHERE slug IN ('easter-camp-form', 'summer-camp-form', 'end-year-camp-form', 'mid-term-camp-form');

-- Insert correct camp form configurations
...
-- Mid-Term Form Config (shared by all mid-term camps)
