...
const Announcements = () => {
    ...
    const fetchAnnouncements = () => {
      try {
        ...
        const docs = galleryImages.filter(item => 
          item.type === 'pdf' && 
          (item.section === 'announcements' || item.section === 'documents')
        );
        setDocuments(docs);
  ...
  const displayPosters = postersWithAnnouncements.length > 0 
    ? postersWithAnnouncements 
    : [
        {
          id: "poster1",
      ...
      <div className="container mx-auto">
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <p className="text-lg text-gray-700 leading-relaxed">
            Keep up with the latest news, events, and important information from Amuse.Ke.
          </p>
        </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center justify-between mb-2">
                        <div className="flex items-center gap-3">
                          ...
                          <span className={cn(
                            ...
                            getPriorityBadgeStyles(announcement.priority)
                          )}>
                      ...
                      <AlertDescription className={cn(
                        "text-gray-700 transition-all duration-300 overflow-hidden", 
                        expandedId === announcement.id ? "max-h-96" : "max-h-8 line-clamp-1"
                      )}>
                      ...
                      <Button 
                        variant="ghost" 
                        size="sm" 
                        className="mt-2 text-forest-600 hover:text-forest-700 hover:bg-forest-50 p-0 h-auto"
